...
const services = [
  { icon: "🧹", title: "Комплексна чистка Xbox", price: "від 600 грн", time: "1–2 год" },
  ...
  { icon: "🎮", title: "Обслуговування геймпадів Xbox", price: "від 400 грн", time: "1–2 год" },
  ...
  return (
    <main style={page}>
      ...
      <section style={hero}>
        ...
        <p style={eyebrow}>NazarkoTech · Ремонт Xbox</p>

        <h1 style={title}>Ремонт та обслуговування Xbox у Львові</h1>

        <p style={subtitle}>
        Чистка, заміна термопасти, ремонт HDMI, живлення, геймпадів,
        SSD та профілактика системи охолодження Xbox.
        </p>
      </section>
      ...
      <section style={cta} className="cta-model">
        <h2 style={ctaTitle}>Потрібен ремонт Xbox?</h2>

        <p style={ctaText}>
          Напиши у Telegram або Viber, коротко опиши проблему та характеристики Xbox.
        </p>
