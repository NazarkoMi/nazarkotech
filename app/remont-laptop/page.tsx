...
const services = [
  { icon: "🧹", title: "Комплексна чистка ноутбука", price: "від 600 грн", time: "1–2 год" },
  { icon: "🌡️", title: "Заміна термопасти", price: "від 400 грн", time: "30–60 хв" },
  { icon: "🖥️", title: "Заміна матриці", price: "індивідуально", time: "1–3 год" },
  { icon: "⌨️", title: "Заміна клавіатури", price: "індивідуально", time: "1–3 год" },
  { icon: "🔋", title: "Заміна батареї", price: "індивідуально", time: "1–2 год" },
  { icon: "🔌", title: "Ремонт розʼєму живлення", price: "від 700 грн", time: "1–3 год" },
  ...
  return (
    <main style={page}>
      ...
      <section style={hero}>
        ...
        <p style={eyebrow}>NazarkoTech · Ремонт ноутбуків</p>

        <h1 style={title}>Ремонт та обслуговування ноутбуків у Львові</h1>

        <p style={subtitle}>
          Чистка, заміна термопасти, матриці, клавіатури, батареї,
          розʼєму живлення, SSD, Windows та діагностика ноутбуків.
        </p>
      </section>
      ...
      <section style={cta} className="cta-model">
        <h2 style={ctaTitle}>Потрібен ремонт ноутбука?</h2>

        <p style={ctaText}>
          Напиши у Telegram або Viber, вкажи модель ноутбука та коротко опиши проблему.
        </p>
